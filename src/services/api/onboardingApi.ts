  ...
  endpoints: (builder) => ({
    ...
    profileSetup: builder.mutation<ProfileSetupResponse, ProfileSetupRequest>({
      query: (formData) => {
        ...
        if (formData.years_of_experience !== undefined && formData.years_of_experience !== null && formData.years_of_experience !== '') {
          body.append('years_of_experience', String(formData.years_of_experience));
        }
