...
import { Heart, MapPin, DollarSign, Calendar, ArrowRight, ChevronLeft, Check } from 'lucide-react';
...
export function InterestsStep({ language, onNext, onBack }: InterestsStepProps) {
  ...
  const t = {
    en: {
      ...
      priceRange: {
        ...
        options: [
          ...
          { value: '5k-20k', label: '$5,000 - $20,000', desc: 'Mid-career artists' },
          { value: '20k-100k', label: '$20,000 - $100,000', desc: 'Established artists' },
          { value: 'above100k', label: 'Above $100,000', desc: 'Blue-chip & investment' },
      ...
      tips: {
        title: 'Pro Tip',
        message: 'Select at least 3 preferences to get personalized recommendations',
      },
      back: 'Back',
      continue: 'Continue',
    },
    ar: {
      ...
      priceRange: {
        ...
        options: [
          { value: 'under5k', label: 'أقل من 5,000 دولار', desc: 'فنانون ناشئون' },
          { value: '5k-20k', label: '5,000 - 20,000 دولار', desc: 'فنانون في منتصف المسيرة' },
          { value: '20k-100k', label: '20,000 - 100,000 دولار', desc: 'فنانون راسخون' },
          { value: 'above100k', label: 'أكثر من 100,000 دولار', desc: 'استثمار ممتاز' },
  ...
  const totalSelections = selectedStyles.length + selectedRegions.length + (selectedPriceRange ? 1 : 0) + selectedPeriods.length;
    ...
    <div className="glass border border-white/10 rounded-3xl p-8 md:p-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-10">
          ...
          >
            <div className="mb-4">
              <h3 className="text-xl text-white mb-1">{content.styles.title}</h3>
          ...
          >
            <div className="mb-4 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">{content.regions.subtitle}</p>
              </div>
            </div>
          ...
          >
            <div className="mb-4 flex items-center gap-2">
              ...
              <div>
                <h3 className="text-xl text-white">{content.priceRange.title}</h3>
                <p className="text-white/60 text-sm">{content.priceRange.subtitle}</p>
              </div>
            </div>
          ...
          >
            <div className="mb-4 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">{content.periods.subtitle}</p>
              </div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
