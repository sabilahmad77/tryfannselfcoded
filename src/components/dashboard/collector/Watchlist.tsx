  ...
  return (
    <div className="glass rounded-2xl p-6 h-full">
      ...
      <div className={`mb-6 ${isRTL ? "text-right" : "text-left"}`}>
        ...
        >
          <div className="w-12 h-12 bg-gradient-to-br from-[#ec4899] to-[#8b5cf6] rounded-xl flex items-center justify-center">
            <Heart className="w-6 h-6 text-white" />
          </div>
          <h2 className="text-2xl text-[#fef3c7]">{t.title}</h2>
        </div>
        <p className="text-sm text-[#cbd5e1]">{t.subtitle}</p>
      </div>
      ...
      <div className="space-y-4">
        {t.items.map((item, index) => (
          <motion.div
            ...
            className="bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-xl p-4 border border-[#334155] hover:border-[#ec4899]/50 transition-all group"
          >
            <div
            ...
            >
              <div className={`flex-1 ${isRTL ? "text-right" : "text-left"}`}>
                ...
                >
                  <h3 className="text-[#fef3c7]">{item.title}</h3>
                  <Badge
                ...
                {item.type === "artwork" ? (
                  <div>
                    <p className="text-sm text-[#cbd5e1] mb-2">{item.artist}</p>
                    <div
                      className={`flex items-center gap-4 ${isRTL ? "flex-row-reverse" : ""}`}
                    >
                      <span className="text-lg text-[#d4af37]">{item.price}</span>
                      <div
                  ...
                  <div>
                    <p className="text-sm text-[#cbd5e1] mb-2">{item.specialty}</p>
                    <div
              ...
              >
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  className="text-[#ec4899] hover:text-[#db2777] hover:bg-[#ec4899]/20 hover:scale-110 transition-all duration-200 cursor-pointer"
                  title={t.notify}
                >
      ...
      <Button
        variant="ghost"
        className="w-full mt-4 text-[#ec4899] hover:text-[#db2777] hover:bg-[#ec4899]/20 transition-all duration-200 cursor-pointer"
      >
        {language === "en"
